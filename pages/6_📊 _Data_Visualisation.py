...
if page == pages[1] :
    ...
    st.write("La taille des feux augmente significativement jusqu’en 2006 et reste stable jusqu’en 2020, et La cause Naturelle augmente à partir de 2006 jusqu’en 2020.")
    st.divider()
